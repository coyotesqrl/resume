...
|===
While at GR, I have worked on several Clojure micro-services, building two from the ground up and pushing them
through to deployment in production. I have helped improved my team's build and deployment process, and by example have
fostered a culture where clear and well-maintained documentation is a release requirement. I worked closely with my team's
lead engineer to improve our logging and telemetry, and have refactored and extracted several libraries that have
reduced the size and complexity of all our micro-services.
